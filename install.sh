...
if [ "$1" == "dev" ]; then
   ...
   curl -L https://raw.githubusercontent.com/extremenetworks/ztmesh-support/host-agent/scripts/hostagent_install_0.0.2.sh | sudo bash -s $1  ; sudo host-agent-cli start -c -t
